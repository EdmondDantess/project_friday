...
export const LearnPack = () => {
        ...
        const getCard = (cards: CardType[]) => {
            ...
            for (let i = 0; i < cards.length; i++) {
                ...
                switch (cardGrade) {    // Если наша карточка имеет 0 звёзд. То в массиве она должна встречаться 6 раз. Если 1 звезда то пушим её 5 раз. 2 звезды пушим 4 раза и тд. Тем самым повышаем вероятность выпадения у карточек которые имеют меньшее кол-во звёзд
                    case (0): {
